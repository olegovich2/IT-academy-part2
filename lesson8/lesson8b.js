...
const template = document.querySelector("#listTemplate"); //не виден на странице, ниже способ решения
const dataToInsert = listData.map((el) => {
  const listItemClone = template.content.cloneNode(true);
  listItemClone.querySelector("#content").id = el.id.toString();
  listItemClone.querySelector("#title").textContent = el.title;
  listItemClone.querySelector("#body").textContent = el.body;
  return listItemClone;
  //   const li = document.createElement("li");
  //   const divId = document.createElement("div");
  //   const divTitle = document.createElement("div");
  //   const divBody = document.createElement("div");
  //   divBody.textContent = el.body;
  //   divTitle.textContent = el.title;
  //   divId.id = el.id.toString();
  //   divId.append(divTitle, divBody);
  //   li.append(divId);
  //   return li;
});
ulList?.append(...dataToInsert);
